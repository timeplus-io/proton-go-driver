...
func TestJSONPaths(t *testing.T) {
	...
	jsonRow.SetValueAtPath("DynamicString", proton.NewDynamic("str"))
	jsonRow.SetValueAtPath("DynamicInt", proton.NewDynamic(int64(48)))
	jsonRow.SetValueAtPath("DynamicMap", proton.NewDynamic(map[string]string{"a": "a", "b": "b"}))
